                                ...
                                <div class="card asset-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="#maintenanceModal" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card asset-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="#flightModal" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card asset-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="#roomModal" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card asset-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="#itModal" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card asset-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="#marketingModal" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card asset-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a href="#rdModal" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Funds allocated for property maintenance, repairs, and upkeep. Comprehensive coverage for all building-related expenses.</p>
                    <div class="row">
                        <div class="col">
    ...
    <div class="modal fade" id="itModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Funds allocated for technology infrastructure, including hardware, software, and network upgrades.</p>
                    <div class="row">
                        <div class="col">
